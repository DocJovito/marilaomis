...
function saveOtp($email, $otp)
{
    ...
    $query = $conn->prepare("UPDATE tbluser SET otp = :otp, otpexp = :expiry_time WHERE email = :email");
    $query->bindParam(':otp', $otp, PDO::PARAM_INT);
    $query->bindParam(':email', $email, PDO::PARAM_STR);
    $query->bindParam(':expiry_time', $expiry_time, PDO::PARAM_STR); // Bind the calculated expiry time
    $query->execute();
